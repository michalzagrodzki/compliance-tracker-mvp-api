...
from services.iso_control import create_iso_control, delete_iso_control, get_iso_control_by_id, get_iso_control_by_name, list_iso_controls, update_iso_control
...
@router_v1.get("/iso-controls",
    summary="List ISO controls with pagination",
    description="Fetches paginated ISO controls from the Supabase table with optional name filtering.",
    response_model=List[Dict[str, Any]],
    tags=["ISO Controls"],
)
...
@router_v1.get("/iso-controls/id/{control_id}",
    summary="Get ISO control by ID",
    description="Get detailed information about a specific ISO control by UUID",
    response_model=Dict[str, Any],
    tags=["ISO Controls"],
)
def get_iso_control(
...
@router_v1.get("/iso-controls/name/{name}",
    summary="Get ISO control by name",
    description="Get detailed information about a specific ISO control by name",
    response_model=Dict[str, Any],
    tags=["ISO Controls"],
)
...
@router_v1.post("/iso-controls",
    summary="Create new ISO control",
    description="Create a new ISO control with name and controls data",
    response_model=Dict[str, Any],
    tags=["ISO Controls"],
)
...
@router_v1.put("/iso-controls/{control_id}",
    summary="Update ISO control by ID",
    description="Update an existing ISO control by UUID",
    response_model=Dict[str, Any],
    tags=["ISO Controls"],
)
...
@router_v1.delete("/iso-controls/{control_id}",
    summary="Delete ISO control by ID",
    description="Delete an ISO control by UUID",
